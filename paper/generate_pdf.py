...
def build_pdf():
    ...
    pdf.cell(0, 5, "PG Scholar, Dept. of Data Science and Business Systems", align="C", ln=True)
    ...
    pdf.set_font("Helvetica", "", 9)
    pdf.cell(0, 5, "Associate Professor, Dept. of Data Science and Business Systems", align="C", ln=True)
    pdf.cell(0, 5, "SRM Institute of Science and Technology, Kattankulathur, India", align="C", ln=True)
